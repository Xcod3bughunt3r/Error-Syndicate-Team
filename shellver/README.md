# [Shellver](https://www.itsecurity.id/home.html)
### *.:: Reverse Shell Cheat Sheet Tool ::.*


##### Install Note::....
````
git clone https://github.com/Xcod3bughunt3r/shellver.git
cd shellver/
chmod 777 *
python setup.py -i / python setup.py -r
````

![shellver shell](https://github.com/0xR0/shellver/blob/master/ss/py.png)

![shellver msf](https://github.com/0xR0/shellver/blob/master/ss/all.png)

[From](https://github.com/Xcod3bughunt3r)
...
## *[Follow](https://github.com/Xcod3bughunt3r/shellver/blob/main/Xcod3bughunt3r.md) Me*